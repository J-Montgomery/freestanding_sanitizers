...
#define SANITIZER_UNRECOVERABLE(sanitizer, fname, ...)                         \
  EXTERN_C ATTR_INTERFACE ATTR_NORETURN void __##sanitizer##_handle_##fname(   \
      __VA_ARGS__);

#define SANITIZER_RECOVERABLE(sanitizer, fname, ...)                           \
  EXTERN_C ATTR_INTERFACE void __##sanitizer##_handle_##fname(__VA_ARGS__);    \
  EXTERN_C ATTR_INTERFACE                                                      \
      ATTR_NORETURN void __##sanitizer##_handle_##fname##_abort(__VA_ARGS__);
